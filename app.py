...
def job_recommendation(resume_text):
    ...
    # Get probabilities for all classes (jobs) and sort the top 5
    predicted_probabilities = rf_classifier_job_recommendation.predict_proba(resume_tfidf)[0]
    top_5_indices = predicted_probabilities.argsort()[-5:][::-1]  # Get top 5 job indices
    top_5_jobs = [rf_classifier_job_recommendation.classes_[i] for i in top_5_indices]
    return top_5_jobs
